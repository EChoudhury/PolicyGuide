...
def make_rollout_videos(input_dir):
    fps = 30
    policy_title = {"model_based": "Model-based policy", "model_free": "Learning-based policy"}
    ...
    for seq_dir in sequences:
        ...
        for i, (caption, task_dir) in enumerate(zip(captions, tasks)):
            ...
            for policy_dir in policies:
                ...
                merged_imgs = merge_images(
                    aff_img, cam_imgs["static_cam"], cam_imgs["gripper_cam"], instruction, policy_title[policy_type]
                )
