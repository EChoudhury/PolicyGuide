...
class R3M(BaseLingunet):
    ...
    def __init__(self, device, input_shape, output_dim, cfg):
    ...
    def _load_vision(self, resnet_model):
        self.r3m = load_r3m(resnet_model, device=self.device).module
    ...
    def _build_decoder(self, decoder_channels):
        ...
        self.segmentation_head = nn.Conv2d(
            decoder_channels[-1], n_classes, kernel_size=kernel_size, padding=kernel_size // 2
        )
