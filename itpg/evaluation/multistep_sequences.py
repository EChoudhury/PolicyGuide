...
from itpg.evaluation.utils import temp_seed
import numpy as np
...
# ALLOWED_TASKS = {
#     "open_drawer", "turn_on_lightbulb", "turn_on_led",
# }
# # ALLOWED_TASKS = {
# #         "open_drawer",
# #         "move_slider_left",
...
#         state = states[0]
#     categories = [task_categories[name] for name in seq]
#     return True #len(categories) == len(set(categories))
...
# if __name__ == "__main__":
#     print("Starting Multistep Sequence Evaluation")
