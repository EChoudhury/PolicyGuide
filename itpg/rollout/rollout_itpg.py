...
from itpg.datasets.base_dataset import get_validation_window_size
from itpg.rollout.rollout_video import RolloutVideo
from itpg.utils.utils import get_portion_of_batch_ids
import hydra
import numpy as np
...
class Rollout(Callback):
    ...
    def __init__(
        ...
        self.outputs = []
        self.modalities = ["lang"]  # ["vis", "lang"] if self.lang else ["vis"]
